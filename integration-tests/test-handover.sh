...
docker run $RUN_ARGS -d --name=i1 --hostname=i1 quay.io/cortexproject/ingester $INGESTER_ARGS
...
docker run $RUN_ARGS -d --name=i2 --hostname=i2 quay.io/cortexproject/ingester $INGESTER_ARGS -ingester.join-after=300s
