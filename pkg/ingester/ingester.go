...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&cfg.MinChunkLength, "ingester.min-chunk-length", 0, "Minimum number of samples in a chunk to flush it to the store. Use with care, if chunks are less than this size they will be discarded.")
